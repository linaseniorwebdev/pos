...
class Tendoo_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        /**
         * Requiring php 7.1 as the minium version
         */
        // if( 
        //     version_compare( phpversion(), '7.1', '<' )
        // ) {
        //     return show_error( __( 'In order to run Tendoo CMS properly, you need to upgrade your php version to 7.1' ) );
        // }
        ...
        $this->lang->load_lines( APPPATH . '/language/*.php' ); // @since 3.0.9

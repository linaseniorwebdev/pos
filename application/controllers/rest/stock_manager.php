...
include_once(APPPATH . '/modules/stock-manager/inc/traits_loader.php'); // Include from Nexo module dir

use Carbon\Carbon;

class Stock_Manager extends REST_Controller
{
    use Stock_Transfert_Trait;

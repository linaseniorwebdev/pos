...
<ul class="nav nav-tabs tab-cart hidden-lg hidden-md"> <!--  -->
    <li ng-click="showPart( 'cart', $event );" class="{{ cartIsActive }}"><a href="#"><?php echo __( 'Panier', 'nexo' );?>  <span class="label label-primary"> {{ totalItems }}</span></a></li>
        ...
        <table class="table" id="cart-details">
            <tfoot class="hidden-xs hidden-sm hidden-md">
                ...
                <tr class="active">
                    <td>
                    <?php 
                    if( store_option( 'nexo_vat_type' ) === 'item_vat' ) {
                        ?>

<div class="row">
    <div class="col-md-12">
        <h3 style="margin-top:0px;"><?php echo __( 'Créer un nouveau produit', 'nexo' );?><a href="<?php echo site_url([ 'dashboard', 'nexo', 'produits', 'create' ] );?>" class="btn btn-primary btn-sm pull-right"><?php echo __( 'Changer de type', 'nexo' );?></a></h3>
    </div>
    <div class="col-md-9">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="input-group">
                  ...
                  <select ng-model="item.shipping" class="form-control" ng-options="option as option.TITRE for option in shippings track by option.ID">
                  </select>
                  <span class="input-group-btn">
                    <button ng-click="selectType( 'create/shipping' )" class="btn btn-default" type="button"><i class="fa fa-plus"></i></button>
                  </span>
                </div>

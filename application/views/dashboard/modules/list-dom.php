<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
        <div class="box <?php echo (riake('highlight', $_GET) == $_module[ 'application' ][ 'namespace' ]) ? 'box-primary' : '' ;
            ...
            ?>" <?php if (!
            Modules::is_active($module_namespace)):?> style="background:#F3F3F3;"
            <?php endif;
            ?>>
            ...
            ?>"
                            class="btn btn-sm btn-default btn-box-tool" data-action="uninstall"><i style="font-size:20px;"
                                class="fa fa-trash"></i>
                            <?php _e('Remove');
            ?></a>
            ...
            ?>"
                            class="btn btn-sm btn-default btn-box-tool" data-action="extract"><i style="font-size:20px;"
                                class="fa fa-archive"></i>
                            <?php _e('Extract');
            ?></a>
                        <a href="<?php echo site_url(array( 'dashboard', 'modules', 'build-assets', $module_namespace ));
            ?>"
                            class="btn btn-sm btn-default btn-box-tool" data-action="extract"><i style="font-size:20px;"
